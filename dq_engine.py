...
Severity routing:
  - WARNING  → submission proceeds, issue recorded in DQResult + 201 response
  - CRITICAL → submission rejected HTTP 400, nothing persisted (UNQ-001)

UNQ-001 (overlapping leave dates) is the only Critical rule.
All other rules are soft warnings.
"""
